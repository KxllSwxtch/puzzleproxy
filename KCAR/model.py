...
cookies = {
    ...
    "_ga_17DVLNK818": "GS2.1.s1754626564$o10$g1$t1754627515$j60$l0$h0",
}
...
response = requests.post(
    "https://api.kcar.com/bc/search/group/model",
    cookies=cookies,
    headers=headers,
    json=json_data,
)
...
# data = '{"wr_eq_sell_dcd":"ALL","wr_in_multi_columns":"cntr_rgn_cd|cntr_cd","wr_eq_mnuftr_cd":"001","wr_eq_model_grp_cd":"004"}'
# response = requests.post('https://api.kcar.com/bc/search/group/model', cookies=cookies, headers=headers, data=data)
