...
response = requests.post(
    "https://api.kcar.com/bc/search/group/modelGrp",
    cookies=cookies,
    headers=headers,
    json=json_data,
)
...
# data = '{"wr_eq_sell_dcd":"ALL","wr_in_multi_columns":"cntr_rgn_cd|cntr_cd","wr_eq_mnuftr_cd":"001"}'
# response = requests.post('https://api.kcar.com/bc/search/group/modelGrp', cookies=cookies, headers=headers, data=data)
